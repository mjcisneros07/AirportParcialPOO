...
public class PassengerController {
    ...
    public static Response removePassenger(long id) {
        try {
            ...
            boolean removido = passengerStorage.removePassenger(id);
            if (!removido) {
    ...
    public static Response changeUser(String idString) {
        try {
            if (idString == null || idString.trim().isEmpty() || idString.equals("Select User")) {
                return new Response("Debe elegir un usuario primero", Status.NOT_FOUND);
            }
            System.out.println("idString a convertir: '" + idString + "'");
            long id;
            try {
            ...
            return new Response("Usuario elegido", Status.OK, p);
        } catch (Exception ex) {
            return new Response("Debe elegir un usuario primero", Status.NOT_FOUND);
        }
    }
